...
public interface Storage { 
     ...
     * By default, Sodbox doesn't reload modified objects after a transaction
     ...
     * Setting the "sodbox.reload.objects.on.rollback" property instructs Sodbox to
     ...
     * class can not be stored as value in Sodbox because it has no such constructor. In this case 
     * serialization mechanism can be used (see below)
     * </TD></TR>
     * <TR><TD><code>sodbox.serialize.transient.objects</code></TD><TD>Boolean</TD><TD>false</TD>
     ...
     * will be stored in the database and after loading there will be N instances in memory.
     * </TD></TR>
     * <TR><TD><code>sodbox.object.cache.init.size</code></TD><TD>Integer</TD><TD>1319</TD>
     * <TD>Initial size of object cache
     * </TD></TR>
     * <TR><TD><code>sodbox.object.cache.kind</code></TD><TD>String</TD><TD>"lru"</TD>
     ...
     * for lru cache by <code>sodbox.object.index.init.size</code> parameter (it can be 0).<br>
     ...
     * </TD></TR>
     * <TR><TD><code>sodbox.object.index.init.size</code></TD><TD>Integer</TD><TD>1024</TD>
     ...
     * </TD></TR>
     * <TR><TD><code>sodbox.extension.quantum</code></TD><TD>Long</TD><TD>1048576</TD>
     ...
     * </TD></TR>
     * <TR><TD><code>sodbox.gc.threshold</code></TD><TD>Long</TD><TD>Long.MAX_VALUE</TD>
     ...
     * after reaching end of allocation bitmap in allocator.
     * </TD></TR>
     * <TR><TD><code>sodbox.lock.file</code></TD><TD>Boolean</TD><TD>false</TD>
     * <TD>Lock database file to prevent concurrent access to the database by 
     * more than one application.
     * </TD></TR>
     * <TR><TD><code>sodbox.file.readonly</code></TD><TD>Boolean</TD><TD>false</TD>
     * <TD>Database file should be opened in read-only mode.
     * </TD></TR>
     * <TR><TD><code>sodbox.file.noflush</code></TD><TD>Boolean</TD><TD>false</TD>
     ...
     * </TD></TR>
     * <TR><TD><code>sodbox.concurrent.iterator</code></TD><TD>Boolean</TD><TD>false</TD>
     ...
     * </TD></TR>
     * <TR><TD><code>sodbox.force.store</code></TD><TD>Boolean</TD><TD>true</TD>
     ...
     * </TD></TR>
     * <TR><TD><code>sodbox.page.pool.lru.limit</code></TD><TD>Long</TD><TD>1L << 60</TD>
     * <TD>Set boundary for caching database pages in page pool. 
     * By default Sodbox is using LRU algorithm for finding candidate for replacement.
     ...
     * for BLOB objects. If you set value of "sodbox.page.lru.scope" property equal
     ...
     * </TD></TR>
     * <TR><TD><code>sodbox.multiclient.support</code></TD><TD>Boolean</TD><TD>false</TD>
     * <TD>Supports access to the same database file by multiple applications.
     * In this case Sodbox will use file locking to synchronize access to the database file.
     ...
     * </TD></TR>
     * <TR><TD><code>sodbox.reload.objects.on.rollback</code></TD><TD>Boolean</TD><TD>false</TD>
     * <TD>By default, Sodbox doesn't reload modified objects after a transaction
     * rollback. In this case, the programmer should not use references to the
     * persistent objects stored in program variables. Instead, the application
     * should fetch the object tree from the beginning, starting from obtaining the
     * root object using the Storage.getRoot method.
     ...
     * used with care.
     * </TD></TR>
     * <TR><TD><code>sodbox.reuse.oid</code></TD><TD>bool</TD><TD>true</TD>
     ...
     * </TD></TR>
     * <TR><TD><code>sodbox.compatibilit.mode</code></TD><TD>int</TD><TD>0</TD>
     * <TD>Bitmask of different compatibility modes. Right now the following modes are supported:
     * IBM_JAVA5_COMPATIBILITY_MODE: compatibility with databases created by Sodbox prior to 2.73 release by IBM Java5 VM
     * CLASS_LOADER_SERIALIZATION_COMPATIBILITY_MODE: compatibility with databases created by Sodbox prior to 2.66 and
     ...
     * </TD></TR>
     * <TR><TD><code>sodbox.search.base.classes</code></TD><TD>bool</TD><TD>true</TD>
     * <TD>This parameter is used by Database class. If there is no table (class extent) corresponding
     * to the requested class, then Sodbox tries to locate class extend for base class and so on.
    ...
    /**
     * This method is used internally by Sodbox to get transaction context associated with current thread.
