...
class RndBtreeCaseInsensitiveMultiFieldIndex<T> extends RndBtreeMultiFieldIndex<T> {
    ...
    RndBtreeCaseInsensitiveMultiFieldIndex(final Class cls, final String[] fieldNames, final boolean unique) {
...
class RndBtreeMultiFieldIndex<T> extends RndBtree<T> implements FieldIndex<T> {
    ...
    RndBtreeMultiFieldIndex(final Class cls, final String[] fieldName, final boolean unique) {
        this.cls = cls;
        this.unique = unique;
