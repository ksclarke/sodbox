...
class AltBtreeCaseInsensitiveFieldIndex<T> extends AltBtreeFieldIndex<T> {
    ...
    AltBtreeCaseInsensitiveFieldIndex(final Class cls, final String fieldName, final boolean unique) {
...
class AltBtreeFieldIndex<T> extends AltBtree<T> implements FieldIndex<T> {
    ...
    AltBtreeFieldIndex(final Class cls, final String fieldName, final boolean unique) {
        this.cls = cls;
        this.unique = unique;
