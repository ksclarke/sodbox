...
public class XMLImporter { 
    ...
    public void importDatabase() throws XMLImportException { 
        ...
        while ((tkn = scanner.scan()) == XMLScanner.XML_LT) { 
            ...
            if (elemName.equals("info.freelibrary.sodbox.impl.Btree") 
                || elemName.equals("info.freelibrary.sodbox.impl.BitIndexImpl")
                || elemName.equals("info.freelibrary.sodbox.impl.PersistentSet") 
                || elemName.equals("info.freelibrary.sodbox.impl.BtreeFieldIndex") 
                || elemName.equals("info.freelibrary.sodbox.impl.BtreeCaseInsensitiveFieldIndex") 
                || elemName.equals("info.freelibrary.sodbox.impl.BtreeCompoundIndex") 
                || elemName.equals("info.freelibrary.sodbox.impl.BtreeMultiFieldIndex")
                || elemName.equals("info.freelibrary.sodbox.impl.BtreeCaseInsensitiveMultiFieldIndex")) 
            { 
