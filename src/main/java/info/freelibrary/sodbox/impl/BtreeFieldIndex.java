...
class BtreeCaseInsensitiveFieldIndex<T> extends BtreeFieldIndex<T> {
    ...
    BtreeCaseInsensitiveFieldIndex(final Class cls, final String fieldName, final boolean unique) {
        super(cls, fieldName, unique);
    }

    BtreeCaseInsensitiveFieldIndex(final Class cls, final String fieldName, final boolean unique,
            final long autoincCount) {
...
class BtreeFieldIndex<T> extends Btree<T> implements FieldIndex<T> {
    ...
    BtreeFieldIndex(final Class cls, final String fieldName, final boolean unique) {
        this(cls, fieldName, unique, 0);
    }

    BtreeFieldIndex(final Class cls, final String fieldName, final boolean unique, final long autoincCount) {
        this.cls = cls;
        this.unique = unique;
