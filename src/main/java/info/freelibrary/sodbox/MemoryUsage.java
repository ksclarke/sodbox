...
/**
 * Information about memory usage for the correspondent class. Instances of this
 * class are created by Storage.getMemoryDump method. Size of internal database
 * structures (object index, memory allocation bitmap) is associated with
...
public class MemoryUsage {
	...
	/**
	 * Real allocated size of all instances. Database allocates space for the
