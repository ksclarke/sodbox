...
public class StorageError extends RuntimeException {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1596081550324114786L;
	...
	private static final String[] messageText = { "", "Storage not opened",
			...
			"Key not found", "Database schema was changed for",
			"Unsupported type", "Unsupported index type",
			"Incompatible key type", "Not enough space",
			"Database file is corrupted",
			"Failed to instantiate the object of",
			"Failed to build descriptor for", "Stub object is accessed",
			"Invalid object reference", "Access to the deleted object",
			"Object access violation", "Failed to locate", "Null value",
			"Could not find indexed field", "Lock could not be granted",
			"No such database property", "Bad property value",
			"Attempt to store persistent object as raw object",
			"Attempt to store java.lang.Object as value",
			"Unsupported encoding", "Storage is used by other application",
	...
	private Exception myOrigException;
