...
public class StorageError extends RuntimeException {
    ...
    /**
     * Creates new storage error with code.
     *
    ...
    /**
     * Creates new storage error with code and root cause.
     *
     * @param aErrorCode An error code
     * @param aCause A root cause
     */
    public StorageError(final int aErrorCode, final Exception aCause) {
        super(MESSAGE_TEXT[aErrorCode] + COLONSPACE + aCause, aCause);
    ...
    /**
     * Creates new storage error with code and param.
     *
     * @param aErrorCode An error code
     * @param aParam A param with more details
     */
    public StorageError(final int aErrorCode, final Object aParam) {
        super(MESSAGE_TEXT[aErrorCode] + SPACE + aParam);
        myErrorCode = aErrorCode;
    }

    /**
     * Creates new storage error with code, param, and root cause.
     *
     * @param aErrorCode An error code
     * @param aParam A param with more details
     * @param aCause A root cause
     */
    public StorageError(final int aErrorCode, final Object aParam, final Exception aCause) {
        super(MESSAGE_TEXT[aErrorCode] + SPACE + aParam + COLONSPACE + aCause, aCause);
    ...
    /**
     * Get original exception if StorageError exception was thrown as the result of catching some other exception
     * within Storage implementation. StorageError is used as wrapper of other exceptions to avoid cascade propagation
