...
public interface TimeSeries<T extends TimeSeries.Tick> extends IPersistent, IResource {
     ...
     *
     * @param timestamp time series element timestamp return time series element for the specified timestamp or null
     ...
     *
     * @param from inclusive time of the begging of interval, if null then take all elements from the beginning of
     *        time series
     * @param till inclusive time of the ending of interval, if null then take all elements till the end of time
     *        series
     ...
     *
     * @param from inclusive time of the begging of interval, if null then remove all elements from the beginning of
     *        time series
     * @param till inclusive time of the ending of interval, if null then remove all elements till the end of time
     *        series
