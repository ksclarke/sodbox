...
public interface SpatialIndex<T> extends IPersistent, IResource {
     ...
     */
    Object[] get(Rectangle aRectangle);
     ...
     */
    ArrayList<T> getList(Rectangle aRectangle);
     ...
     */
    void put(Rectangle aRectangle, T aObject);
     ...
     */
    void remove(Rectangle aRectangle, T aObject);
     ...
     */
    IterableIterator<T> iterator(Rectangle aRectangle);
     ...
     */
    IterableIterator<Map.Entry<Rectangle, T>> entryIterator(Rectangle aRectangle);
     ...
     */
    IterableIterator<T> neighborIterator(int aX, int aY);
