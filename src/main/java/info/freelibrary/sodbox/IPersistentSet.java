...
public interface IPersistentSet<T> extends IPersistent, IResource, Set<T> {
     ...
     * full text search engine (please notice that Sodbox has built-in full text search engine). So we have inverse
     ...
     * </code>
     *
     * @param iterator set of object ordered by OID. Usually it is iterator of IPersistentSet class. This parameter
