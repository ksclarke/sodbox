...
public interface MultidimensionalIndex<T> extends IPersistent, IResource {
     ...
     *
     * @param pattern object which is used as search pattern, non null values of components of this object forms
     *        search condition
     ...
     * and high objects.
     *
     * @param low pattern object specifying inclusive low boundary for field values. If there is no low boundary for
     ...
     *        fields.
     * @param high pattern object specifying inclusive high boundary for field values. If there is no high boundary
