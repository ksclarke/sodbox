...
public interface FieldIndex<T> extends GenericIndex<T> {
     ...
     *
     * @param obj object to be inserted in index. Object should contain indexed field of integer (<code>int</code> or
     *        <code>long</code>) type. This field is assigned unique value (which will not be reused while this index
     *        exists) and object is marked as modified. Object can be not yet persistent, in this case its forced to
     *        become persistent by assigning OID to it.
     * @exception StorageError(StorageError.INCOMPATIBLE_KEY_TYPE) when indexed field has type other than
     ...
     *
     * @param obj object to be inserted in index. Object should contain indexed field. Object can be not yet
