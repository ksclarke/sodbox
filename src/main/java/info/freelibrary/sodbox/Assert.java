 ...
 * macro. The Java compiler doesn't provide information about compiled file and
 * line number, so the place of assertion failure can be located only by
 * analyzing the stack trace of the thrown AssertionFailed exception.
 * 
