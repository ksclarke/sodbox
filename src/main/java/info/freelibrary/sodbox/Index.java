...
public interface Index<T> extends GenericIndex<T> {
     ...
     * @param obj object associated with this key. Object can be not yet persistent, in this case its forced to become
     ...
     * @exception StorageError(StorageError.KEY_NOT_FOUND) exception if there is no such key in the index, or
     *            StorageError(StorageError.KEY_NOT_UNIQUE) if index is not unique.
     */
