...
public interface Index<T> extends GenericIndex<T> {
	...
	/**
	 * Remove object with specified key from the index. The only difference with
	 * remove is that it doesn't throw an exception when key is not found but
	 * return false
	 * 
	 * @param key value of the key of removed object
	 * @param obj object removed from the index
	 * @return true if object was successfully deleted, false if it is not found
	 *         in the index
	 */
