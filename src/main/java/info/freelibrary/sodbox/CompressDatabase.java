...
/**
 * Utility used to compress database file. You should create database using
 * normal file (OSFile). Then use this utility to compress database file. To
 * work with compressed database file you should path instance if this class in
...
public class CompressDatabase {
	...
	public static void main(String[] args) throws IOException {
		if (args.length == 0 || args.length > 2) {
			System.err
					.println("Usage: java info.freelibrary.sodbox.CompressDatabase DATABASE_FILE_PATH [COMPRESSION-LEVEL]");
			return;
		}
